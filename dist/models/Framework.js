...
exports.FrameworkModel = void 0;
const mongoose_1 = __importStar(require("mongoose"));
const dotenv_1 = __importDefault(require("dotenv"));
const uuid_1 = require("uuid");
dotenv_1.default.config();
const oldVersionsSchema = new mongoose_1.Schema({
...
const frameworkSchema = new mongoose_1.Schema({
    id: { type: String, required: true, unique: true, default: () => (0, uuid_1.v4)() },
...
exports.FrameworkModel = mongoose_1.default.model('Framework', frameworkSchema);
